...
const int buzzPin=6;
#endif
#define doorPin output1Pin
#define detectPin input1Pin
#define addr1Pin input2Pin
#define addr2Pin input3Pin
#define addr3Pin input4Pin
//#define addr4Pin input5Pin
#define testAddrPin output2Pin
/******************************Globe Flag*******************************************************************/
struct FLAG_BITES{
	unsigned char isDoorOpened:1;
