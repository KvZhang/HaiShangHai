...
const int output2Pin=A4;
const int output3Pin=A5;
const int output4Pin=A6;
#if ON_BOARD_MOS>4
...
#endif
volatile unsigned char myOpenID;
volatile unsigned char failCount;
/*************************************************************************************************/
